//! Portal template — a single runnable Rust+wgpu scene that
//! demonstrates the moving parts of a trikala game.
//!
...
impl ApplicationHandler for App {
    fn resumed(&mut self, event_loop: &ActiveEventLoop) {
        let attrs = Window::default_attributes()
            .with_title("{{project-name}} — portal · WASD/Arrows · Space · F · V · Esc")
