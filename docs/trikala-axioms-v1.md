...
**U11.** Self-update first-class — install primary ผ่าน `curl -fsSL trikala.dev/install.sh | sh`, update ผ่าน `trikala upgrade`. `cargo install` คือ secondary, ไม่ใช่ primary install path
